...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Finds the biggest Rect based on the area
        Args:
            rect_1: Rectangle instance
            rect_2: Rectangle instance different from rect_1
        Returns:
            The inst with the biggest area,
            or rect_1 if both rects have the same area
        """
    ...
    def square(cls, size=0):
        """Creates a new Rect inst with width == height == size
        Args:
            size: size to set the new rect to
        Returns:
            The new Rect inst
        """
